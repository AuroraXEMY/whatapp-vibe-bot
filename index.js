...
async function analyzeImageWithGemini(base64Image, mimeType, question) {
  // Not Gemini-only anymore: tries Gemini first, then falls back to
  // OpenRouter's confirmed free vision model (google/gemma-4-31b-it:free) —
  // per your request not to rely on a single provider for this.
  const attempts = [];
