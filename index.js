  ...
  sock.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      if (statusCode === 405 || statusCode === 401) {
        console.log("👉 Troubleshooting: If the session was revoked or logged out from the WhatsApp app, please clear your MongoDB 'sessions' collection and run 'npm run pair' to generate a fresh connection.");
      }
